...
- Summarize long documents using state-of-the-art LLMs

- Modular architecture (OCR, Translation, Summarization)

- Uses Flask for a simple web interface

Tech Stack:
Python · OpenCV · Tesseract · Hugging Face · Flask
